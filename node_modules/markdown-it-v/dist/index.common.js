...
var _fromPairs = _interopDefault(require('lodash/fromPairs'));
var utils = require('markdown-it/lib/common/utils');
var OriginalRenderer = _interopDefault(require('markdown-it/lib/renderer'));
  ...
  _createClass(Node, [{
    ...
    value: function renderAttrsToHTML() {
      return Object.entries(this.attrs).map(function (_ref3) {
        ...
        return "".concat(utils.escapeHtml(key), "=\"").concat(utils.escapeHtml(value), "\"");
      }).join(' ');
    }
  }, {
    key: "renderInnerHTML",
    value: function renderInnerHTML() {
      ...
      if (voidElements.includes(this.tagName)) {
        ...
        return this.children.map(function (child) {
          return typeof child === 'string' ? utils.escapeHtml(child) : child.renderToHTML(xhtmlOut);
        }).join('');
      } else {
